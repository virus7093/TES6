...
<html>
    ...
    <body>
        ...
        <div class="bord1">
            ...
            <h2>Glisses les compétences que tu veux utiliser en combat à la place d'une des 4 actives</h2>
        </div>
        <div class="bord2">
            <div class="skills" id="skills">
                <h1 id="rien" hidden>Tu devrais apprendre de nouvelles compétences,</br> Va voir Michael Jack... Le vieux Sensei à Corynthe pour en apprendre de nouvelles !</h1>
            </div>
